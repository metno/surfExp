...
def get_exp_from_files(tmp_path_factory):
    ...
    with patch('experiment_scheduler.scheduler.ecflow') as mock_ecflow:
        sfx_exp = experiment.ConfigurationFromJsonFile(exp_configuration_file)
        return sfx_exp
...
class TestFlow():
    ...
    def test_ecflow_suite_task(self, ecflow, tmp_path_factory, get_exp_from_files):
        ...
        task_settings = experiment_scheduler.TaskSettings(config)
    ...
    def test_ecflow_sufex_suite(self, mock, tmp_path_factory, get_exp_from_files):
        ...
        with patch('experiment_scheduler.suites.ecflow') as mock_ecflow:
            experiment.SurfexSuite(suite_name, config, joboutdir, task_settings, dtgs,
